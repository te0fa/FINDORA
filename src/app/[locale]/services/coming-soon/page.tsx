...
export default function ServicesComingSoon({ params }: PageProps) {
  const { locale } = use(params);
  const isRTL = locale === "ar";

  const content = {
    title: isRTL ? "خدمات فايندورا 🚀" : "Findora Services 🚀",
    badge: isRTL ? "قريباً جداً" : "Coming Soon",
    desc: isRTL
      ? "نعمل حالياً على تطوير وإطلاق خدمات فايندورا المتكاملة لتلبية كافة احتياجات التوريد الخاصة بكم. ترقبوا إطلاق خدماتنا قريباً!"
      : "We are currently developing and launching Findora's integrated services to meet all your sourcing needs. Stay tuned for our upcoming release!",
