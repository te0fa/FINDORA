...
- Name: staff.ai-control.spec.ts >> AI Control Panel E2E & RBAC Tests >> should open configuration modal and allow adjusting daily/monthly limits
- Location: e2e\staff.ai-control.spec.ts:54:7
...
Call log:
  - waiting for locator('.feature-card').filter({ hasText: 'NATURAL LANGUAGE SOURCING PARSING' }).locator('.btn-configure')
