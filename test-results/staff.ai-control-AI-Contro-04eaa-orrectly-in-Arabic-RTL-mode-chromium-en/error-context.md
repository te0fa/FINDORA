...
- Name: staff.ai-control.spec.ts >> AI Control Panel E2E & RBAC Tests >> should support localization and render correctly in Arabic RTL mode
- Location: e2e\staff.ai-control.spec.ts:34:7
...
Call log:
  ...
  - waiting for locator('.header-title')
