...
async function run() {
  ...
  const filePath = path.join(__dirname, '../supabase/migrations/20260625145000_unified_pricing_architecture.sql');
  ...
  console.log(`Applying 20260625145000_unified_pricing_architecture.sql...`);
