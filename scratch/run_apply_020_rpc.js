...
async function main() {
  ...
  console.log('Calling RPC fn_exec_sql on Supabase remote DB to apply migration 020...');
  ...
  try {
    ...
    if (error) {
      ...
      console.log('✅ SUCCESS: Migration 020 applied successfully via RPC fn_exec_sql!');
